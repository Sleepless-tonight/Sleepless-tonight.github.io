package com.nostyling.create.util.mybatis;
...
public class SelectDemo {
    public static void main(String[] args) throws Exception {
        ...
        //a.查询工资低于10000的员工
        List <User> result = sqlSession.selectList("com.nostyling.create.modular.dao.UserMapper.selectUsers",params);
        //b.未传最低工资，查所有员工
        List<User> result1 = sqlSession.selectList("com.nostyling.create.modular.dao.UserMapper.selectUsers");
